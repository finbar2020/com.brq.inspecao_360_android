...
public final class DownloadMapsService_MembersInjector implements MembersInjector {
   // $FF: synthetic field
   ...
   public DownloadMapsService_MembersInjector(MembersInjector var1, Provider var2, Provider var3, Provider var4, Provider var5) {
   ...
   public static MembersInjector create(MembersInjector var0, Provider var1, Provider var2, Provider var3, Provider var4) {
      DownloadMapsService_MembersInjector var5 = new DownloadMapsService_MembersInjector(var0, var1, var2, var3, var4);
      return var5;
   }

   public void injectMembers(DownloadMapsService var1) {
      if (var1 != null) {
