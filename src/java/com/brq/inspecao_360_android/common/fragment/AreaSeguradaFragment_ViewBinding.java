...
public class AreaSeguradaFragment_ViewBinding implements Unbinder {
   protected AreaSeguradaFragment target;

   @UiThread
   public AreaSeguradaFragment_ViewBinding(AreaSeguradaFragment var1, View var2) {
      this.target = var1;
   ...
   @CallSuper
   public void unbind() {
      AreaSeguradaFragment var1 = this.target;
      if (var1 != null) {
         var1.txtTitulo = null;
         var1.recyclcer = null;
         this.target = null;
