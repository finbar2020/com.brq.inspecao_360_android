...
import com.brq.inspecao_360_android.presentantion.presenter.impl.EnquadrarDialogFragmentPresenterImpl.2.1;
import java.util.List;
import rx.Subscriber;

class EnquadrarDialogFragmentPresenterImpl$2 extends Subscriber {
   // $FF: synthetic field
   final EnquadrarDialogFragmentPresenterImpl this$0;
   // $FF: synthetic field
   final ProdutoComercial val$produtoComercial;

   EnquadrarDialogFragmentPresenterImpl$2(EnquadrarDialogFragmentPresenterImpl var1, ProdutoComercial var2) {
      this.this$0 = var1;
      this.val$produtoComercial = var2;
   }
   ...
   public void onNext(List var1) {
      EnquadrarDialogFragmentPresenterImpl.access$000(this.this$0).addEnquadramentosSpinner(var1);
   }
