...
public class ItemInspecaoDevolverActivity_ViewBinding extends BaseActivity_ViewBinding {
   @UiThread
   public ItemInspecaoDevolverActivity_ViewBinding(ItemInspecaoDevolverActivity var1, View var2) {
      super(var1, var2);
   ...
   public void unbind() {
      ItemInspecaoDevolverActivity var1 = (ItemInspecaoDevolverActivity)this.target;
      super.unbind();
